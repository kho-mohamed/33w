...
{ ?>
    ...
    <svg class="style-vague" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="<?= $couleur_bas ?>" fill-opacity="1"
...
function extraire_list_categories($nom_categorie)
{
    ...
    $parent_category_id = get_category_by_slug($nom_categorie);
    $tableau = array(
    ...
    echo "</ul>";
    // on peut aussi faire un return si on veut utiliser la fonction dans une variable
